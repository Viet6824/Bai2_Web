...
## Lớp: K58KTP
### BÀI TẬP 2
Sử dụng github để ghi lại quá trình làm, tạo repo mới, để truy cập public, edit file readme.md: chụp ảnh màn hình (CTRL+Prtsc) lúc đang làm, paste vào file readme.md, thêm mô tả cho ảnh.
NỘI DUNG BÀI TẬP:
